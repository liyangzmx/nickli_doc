...
\begin{itemize}
   ...
   \item 采取静态链接到libwebrtc.a的方式优化native库对WebRTC的设置和尺寸.
...
\item WYZE App(Android)
   \begin{itemize}
      ...
      \item 基于GStramer(for Android)的下一代播放器调研
      \item 部分关于App的Jenkins打包Pipeline脚本(Groovy)编写
   \end{itemize}
\end{itemize}
}

\subsection{Android BSP开发}
\cventry{2018/3--2019/12}{智能硬件部}{北京小米移动软件科技有限公司}{}{}{
\textbf{工作描述：}
\begin{itemize}
...
\cventry{2016/9--2018/03}{软件一部}{北京小鸟听听科技有限公司}{}{}{
\textbf{工作描述：}:
\begin{itemize}
